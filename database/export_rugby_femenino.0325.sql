CREATE DATABASE  IF NOT EXISTS `rugby_femenino` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `rugby_femenino`;
-- MySQL dump 10.13  Distrib 8.0.41, for macos15 (x86_64)
--
-- Host: 127.0.0.1    Database: rugby_femenino
-- ------------------------------------------------------
...
-- Dump completed on 2025-03-15 16:18:11
